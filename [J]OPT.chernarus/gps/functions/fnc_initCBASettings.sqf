...
[
    QGVAR(showAllUnits), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    "Für HL alle Einheiten auf Karte markieren", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
...
[
    ...
    "SLIDER", // setting type
    "Update Interval in Sekunden", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    "OPT GPS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
