...
[
	...
	[_healer, _patient],
	{
        ...
        private _name1 = [_patient] call EFUNC(log,getPlayerName);
		private _name2 = [_healer] call EFUNC(log,getPlayerName);

        private _message = format [
            "%1 (%2) wurde von %3 (%4) stabilisiert.", 
            _name1, 
            [_patient] call EFUNC(common,getPlayerSide),
            _name2,
            [_healer] call EFUNC(common,getPlayerSide)
        ];
