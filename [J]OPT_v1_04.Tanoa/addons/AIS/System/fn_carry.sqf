...
if (primaryWeapon _unit isEqualTo "") exitWith {
	["Aktion nur mit Primärwaffe möglich.", "red"] call AIS_Core_fnc_dynamicText;
};
...
if (_unit call AIS_System_fnc_checkLauncher) exitWith {
	["Du kannst niemanden tragen, solange du einen Launcher trägst.", "red"] call AIS_Core_fnc_dynamicText;
};
