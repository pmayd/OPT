...
[
    ...
    "SLIDER", // setting type
    "Minimale Absprung-Höhe für Fallschirm", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    "OPT Autoparachute", // Pretty name of the category where the setting can be found. Can be stringtable entry.
    [25, 100, 50, 0], // Default value <BOOLEAN>
    1, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
    {} // function that will be executed once on mission start and every time the setting is changed.
] call CBA_Settings_fnc_init;
...
[
    ...
    "OPT Autoparachute", // Pretty name of the category where the setting can be found. Can be stringtable entry.
    [5, 60, 5, 0], // Default value <BOOLEAN>
    1, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
    {} // function that will be executed once on mission start and every time the setting is changed.
] call CBA_Settings_fnc_init;