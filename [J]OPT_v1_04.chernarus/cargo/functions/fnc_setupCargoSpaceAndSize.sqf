...
// NATO Helicopters	
	...
	["OPT_B_Heli_Transport_02_F", 4],					// CH-49 Mohawk (Transport+Lift)    von 30
	["OPT_B_Heli_Transport_03_unarmed_F", 4],			// CH-67 Huron unarmed (Transport+Lift)     von 30
	["OPT_B_Heli_Transport_03_F", 4],					// CH-67 Huron armed (Transport+Lift)       von 30
...
// CSAT Helicopter
	...
	["OPT_O_Heli_Transport_04_covered_black_F", 4], 	// Mi-290 Taru (Transport),110000
...
[											
	...
	["OPT_B_Slingload_01_Fuel_F", [0, 2, 0.1], 90],                         // Fuelcontainer,5000
	["OPT_B_Slingload_01_Ammo_F", [0, 2, 0.1], 90],                         // Munitionscontainer,50000
	["OPT_B_Slingload_01_Repair_F", [0, 2, 0.1], 90],                       // Reparaturcontainer,5000
	["OPT_Land_Pod_Heli_Transport_04_repair_black_radar_F", [0, 2, 0.1], 90],    	// NATO Radar Container
	["OPT_B_Slingload_01_Medevac_F", [0, 2, 0.1], 90], // Lazarettcontainer,5000			//psycho, dieser container verursacht Probleme mit den Load-Scripts und wird durch den weissen Container ersetzt welcher zum Lazarett ausgebaut werden kann
// NATO ships	
...
//CSAT supplies
	...
	["OPT_Land_Pod_Heli_Transport_04_fuel_F", [0, 3, 0.1], 90],			    // Fuelcontainer,5000
	["OPT_Land_Pod_Heli_Transport_04_fuel_black_F", [0, 3, 0.1], 90],	    // Fuelcontainer (schwarz),5000
	["OPT_Land_Pod_Heli_Transport_04_ammo_F", [0, 3, 0.1], 90],		        // Munitionscontainer,50000
	["OPT_Land_Pod_Heli_Transport_04_ammo_black_F", [0, 3, 0.1], 90],	    // Munitionscontainer (Schwarz),50000
	["OPT_Land_Pod_Heli_Transport_04_repair_F",	[0, 3, 0.1], 90],		    // Reparaturcontainer,5000
	["OPT_Land_Pod_Heli_Transport_04_repair_black_F", [0, 3, 0.1], 90],	    // Reparaturcontainer (schwarz),5000
	["OPT_Land_Pod_Heli_Transport_04_repair_radar_F", [0, 3, 0.1], 90],     // CSAT Radar Container
	["OPT_Land_Pod_Heli_Transport_04_medevac_F", [0, 3, 0.1], 90],			// Lazarettcontainer,5000			//psycho, dieser container verursacht Probleme mit den Load-Scripts und wird durch den weißen Container ersetzt welcher zum Lazarett ausgebaut werden kann
//CSAT ships
