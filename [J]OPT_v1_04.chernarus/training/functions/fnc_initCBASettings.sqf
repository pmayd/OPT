...
[
    ...
    "Schlacht oder Training", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    "Trainingsmodus", // Pretty name of the category where the setting can be found. Can be stringtable entry.
