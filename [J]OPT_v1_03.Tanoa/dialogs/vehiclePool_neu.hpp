opt_vehiclesNato = [
	...
	["OPT_B_MRAP_03_gmg_F",40000],							// Strider GMG,32500
	["OPT_B_Truck_01_covered_F",8000], 						// HEMTT Transport,8000
	["OPT_B_Truck_01_Repair_F",0], 							// HEMTT Repair,10000 ersetzt durch Container
...
opt_choppersNato = [
	...
	["OPT_B_Heli_Attack_01_F",0],						// AH-99 Blackfoot,750000
	["OPT_B_Heli_Transport_03_unarmed_F",150000],			// CH-67 Huron unarmed (Transport+Lift),150000
	["OPT_B_Heli_Transport_03_F",0],					// CH-67 Huron armed (Transport+Lift),170000
	["OPT_B_Plane_CAS_01_AA_F",0],						// A-164 Wipeout light,250000
	["OPT_B_Plane_CAS_01_F",0],						// A-164 Wipeout,540000
	...
	["B_T_UAV_03_F",0],										// MQ12-Falcon
	["OPT_B_T_VTOL_01_infantry_F",200000],					// Blackfish (Inf-Transport)
	["OPT_B_T_VTOL_01_vehicle_F",0],					// Blackfish (Fahrzeug-Transport)
	["OPT_B_T_VTOL_01_armed_F",0]						// Blackfish BEWAFFNET
];
...
opt_armoredNato = [
	...
	["OPT_B_APC_Tracked_01_rcws_F",0],					// IFV-6c Panther,45000
	["OPT_B_APC_tracked_03_cannon_F",0],				// FV-720 Mora,100000
	["OPT_B_APC_Tracked_01_AA_F",0],					// IFV-6a Cheetah,275000
	["OPT_B_MBT_01_cannon_F",0],						// M2A4 Slammer,340000
...
opt_vehiclesCsat = [
	["OPT_O_T_Quadbike_01_ghex_F",1000],					// Quadbike,500
	...
	["OPT_O_T_Truck_03_repair_ghex_F",0],					// Tempest Repair,10000 ersetzt durch container
...
opt_choppersCsat = [
	["OPT_O_Heli_Light_03_unarmed_F",0],					// WY-55 Hellcat,70000
	["OPT_O_Heli_Light_03_unarmed_green_F",50000],			// WY-55 Hellcat,70000
	["OPT_O_Heli_Light_03_F",0],							// WY-55 Hellcat (DAR),170000	
	["OPT_O_Heli_Light_03_green_F",140000],					// WY-55 Hellcat (DAR),170000	
	["OPT_O_Heli_Light_02_unarmed_F",0],					// PO-30 Orca,100000
	["OPT_O_Heli_Light_02_unarmed_black_F",60000],			// PO-30 Orca,100000
	["OPT_O_Heli_Light_02_v2_F",0],							// PO-30 Orca (DAR),200000
	["OPT_O_Heli_Light_02_v2_black_F",140000],				// PO-30 Orca (DAR),200000
	...
	["OPT_O_Heli_Transport_02_F",150000],					// CH-49 Mohawk (Transport+Lift),150000	
	["OPT_O_Heli_Attack_02_F",0],							// Mi-48 Kajman,800000	
	["OPT_O_Heli_Attack_02_black_F",0],				// Mi-48 Kajman (Schwarz),800000	
	["OPT_O_Plane_Fighter_03_CAS_F",0],				// A-143 Buzzard (CAS),450000
	["OPT_O_Plane_Fighter_03_AA_F",0],					// A-143 Buzzard (AA),500000
	["OPT_O_Plane_CAS_02_AA_F",0],						// To-199 Neophron light,250000 - oder raus und nur noch buzzard
	["OPT_O_Plane_CAS_02_F",0],						// To-199 Neophron,560000
	...
	["O_T_UAV_04_CAS_F",0],									// KH-3A Fenghuan, 400000
	["OPT_O_T_VTOL_02_infantry_F",0],					// Y-32 Xi'an (Inf-Transport), 180000
	["OPT_O_T_VTOL_02_vehicle_F",0],					// Y-32 Xi'an (Fahrzeug-Transport), 200000
	["OPT_O_T_VTOL_02_infantry_unarmed_F",160000],			// Y-32 Xi'an (Inf-Transport), 180000
	["OPT_O_T_VTOL_02_vehicle_unarmed_F",210000]			// Y-32 Xi'an (Fahrzeug-Transport), 180000
];
...
opt_armoredCsat = [
	...
	["OPT_O_T_APC_Tracked_02_cannon_ghex_light_F",0],	// BTR-K Kamysh,100000
