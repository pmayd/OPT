...
zlt_rope_helis = ["OPT_O_Heli_Light_02_F","OPT_O_Heli_Light_02_unarmed_F","OPT_B_Heli_Transport_01_F","OPT_B_Heli_Transport_01_camo_F",
"OPT_O_Heli_Transport_04_transport_F","OPT_O_Heli_Transport_04_bench_F","OPT_B_Heli_Transport_03_F","OPT_B_Heli_Transport_03_unarmed_F","OPT_O_Heli_Attack_02_F", "OPT_O_Heli_Attack_02_black_F",
"OPT_B_Heli_Transport_02_F","OPT_O_Heli_Transport_02_F","OPT_O_Heli_light_03_unarmed_F","OPT_O_Heli_light_03_F","OPT_B_Heli_Light_01_F"];
zlt_rope_helidata = 
[
	[
		["OPT_O_Heli_Light_02_F", "OPT_O_Heli_Light_02_unarmed_F"],
		[1.35,1.35,-24.95],
		[-1.45,1.35,-24.95]
	],
	[
		["OPT_B_Heli_Transport_01_F", "OPT_B_Heli_Transport_01_camo_F"],				
		[-1.11,2.5,-24.7],
		[1.11,2.5,-24.7]
	],
	[
		["OPT_O_Heli_Transport_04_transport_F","OPT_O_Heli_Transport_04_bench_F"],
		[1.3,1.3,-25],
		[-1.3,1.3,-25]
	],	
	[
		["OPT_B_Heli_Transport_03_F", "OPT_B_Heli_Transport_03_unarmed_F"],
		[-1.11,-3.5,-24.9],
		[1.08,-3.5,-24.9]
	],
	[
		["OPT_O_Heli_Attack_02_F", "OPT_O_Heli_Attack_02_black_F"],
		[1.3,1.3,-25],
		[-1.3,1.3,-25]
	],
	[
		["OPT_B_Heli_Transport_02_F","OPT_O_Heli_Transport_02_F"],
		[0,-5,-26],
		[]
	],
	[
		["OPT_O_Heli_light_03_unarmed_F","OPT_O_Heli_light_03_F"],
		[0.7,2.5,-24.9],
		[-0.9,2.5,-24.9]
	],	
	[
