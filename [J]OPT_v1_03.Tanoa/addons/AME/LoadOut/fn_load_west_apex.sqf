...
// Nato troups dont fit to the green djungle
removeHeadgear player; player addHeadgear "H_HelmetB_tna_F";	// Tropic helmet
removeUniform player; player forceAddUniform "U_B_T_Soldier_F";	// tropic uniform
...
// Appearance
{
    ...
    ["OPT_NATO_Scharfschuetze",									"U_B_T_FullGhillie_tna_F",	"",						"",					"H_ShemagOpen_tan"],
    ["OPT_NATO_Beobachter",										"U_B_T_Sniper_F",			"",						"",					"H_HelmetB_camo"],
...
// Items
{
    ...
    ["OPT_NATO_Pilot",
        [["NVGoggles_tna_F",1], ["FirstAidKit",1], ["30Rnd_45ACP_Mag_SMG_01",2]],
        [],
        [["SmokeShellGreen", 1], ["SmokeShell",2], ["H_Cap_headphones"]]										//kallek
    ],
    ...
    ["OPT_NATO_Pionier",
        [["30Rnd_556x45_Stanag_Tracer_Red",2], ["NVGoggles_tna_F",1]],
    ...
    ["OPT_NATO_Scharfschuetze",
        ...
        [],
        [["7Rnd_408_Mag",4], ["APERSTripMine_Wire_Mag",1], ["NVGoggles_tna_F",1], ["16Rnd_9x21_Mag",2]]			//kallek
    ],
    ["OPT_NATO_Beobachter",
        [["SmokeShellGreen",1], ["SmokeShell",2], ["NVGoggles_tna_F",1], ["Laserbatteries",2]],
        [["FirstAidKit",2]],
        [["20Rnd_762x51_Mag",3], ["SmokeShellGreen",3]]
    ],
    ["OPT_NATO_Gruppenfuehrer",
        [["SmokeShellGreen",3], ["SmokeShell",3], ["Laserbatteries",2]],										//kallek
        [["FirstAidKit",2]],
        [["30Rnd_556x45_Stanag_Tracer_Red",4], ["HandGrenade",2], ["NVGoggles_tna_F",1]]
    ],
    ["OPT_NATO_Grenadier",
...
// Weapons
{
    ...
    ["OPT_NATO_Operator", ["OPT_Laserdesignator", ["OPT_arifle_SPAR_01_blk_C_F", ["acc_pointer_IR", "optic_Aco"]]]],								//kallek
    
    ["OPT_NATO_PA_Schuetze_Heavy", ["Binocular", ["OPT_arifle_SPAR_01_blk_C_F", ["acc_pointer_IR", "optic_Aco"]], "OPT_launch_RPG32_ghex_F"]],
    ["OPT_NATO_PA_Schuetze", ["Binocular", ["OPT_arifle_SPAR_01_blk_C_F", ["acc_pointer_IR", "optic_Aco"]], "OPT_launch_RPG32_ghex_F"]],
    ["OPT_NATO_Aufklaerung_Spaeher_AT", ["Binocular", ["OPT_arifle_SPAR_01_blk_C_F", ["acc_pointer_IR", "optic_Aco"]], "OPT_launch_RPG32_ghex_F"]],
    ["OPT_NATO_Luftabwehrspezialist", ["Binocular", ["OPT_arifle_SPAR_01_blk_C_F", ["acc_pointer_IR", "optic_Aco"]], "OPT_launch_B_Titan_tna_F"]],
    
    ["OPT_NATO_Gruppenfuehrer", ["OPT_Laserdesignator", ["OPT_arifle_SPAR_01_blk_F", ["acc_pointer_IR", "optic_ERCO_blk_F"]]]],						//kallek
    ...
    ["OPT_NATO_SMG_Schuetze", ["Binocular", ["OPT_MMG_02_black_F", ["acc_pointer_IR", "bipod_01_F_snd"]]]],				// 2x 130x 0.338
    ["OPT_NATO_MG_Schuetze", ["Binocular", ["OPT_LMG_Mk200_F", ["acc_pointer_IR", "optic_Aco", "bipod_01_F_snd"]]]],		// 3x 200x 6,5mm
	
    ["OPT_NATO_Scharfschuetze", ["Rangefinder", ["OPT_srifle_LRR_tna_LRPS_F", ["optic_LRPS"]], "hgun_P07_F"]],										//kallek
