...
#include "R3F_LOG_ENABLE.h"
	...
	if !(isDedicated) then
	{
		...
		R3F_LOG_FNCT_usine_remplir_liste_objets = compile preprocessFile "addons\R3F_LOG\usine_creation\remplir_liste_objets.sqf";
		R3F_LOG_FNCT_usine_creer_objet = compile preprocessFile "addons\R3F_LOG\usine_creation\creer_objet.sqf";
		R3F_LOG_FNCT_usine_ouvrir_usine = compile preprocessFile "addons\R3F_LOG\usine_creation\ouvrir_usine.sqf";
		R3F_LOG_FNCT_usine_init = compile preprocessFile "addons\R3F_LOG\usine_creation\usine_init.sqf";
		R3F_LOG_FNCT_usine_revendre_deplace = compile preprocessFile "addons\R3F_LOG\usine_creation\revendre_deplace.sqf";
		R3F_LOG_FNCT_usine_revendre_selection = compile preprocessFile "addons\R3F_LOG\usine_creation\revendre_selection.sqf";
		R3F_LOG_FNCT_usine_revendre_direct = compile preprocessFile "addons\R3F_LOG\usine_creation\revendre_direct.sqf";
		R3F_LOG_FNCT_recuperer_liste_cfgVehicles_par_categories = compile preprocessFile "addons\R3F_LOG\usine_creation\recuperer_liste_cfgVehicles_par_categories.sqf";
		R3F_LOG_FNCT_determiner_cout_creation = compile preprocessFile "addons\R3F_LOG\usine_creation\determiner_cout_creation.sqf";
