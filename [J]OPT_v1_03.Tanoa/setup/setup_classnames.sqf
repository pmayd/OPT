...
/*
Fr jede Flagge in einem Sektor: unverwundbar, Logistik-Script aus
Sowie Actionmeneintrag fr Spieler
*/
{
	_x addAction [
...
//-------------------------------------------------------------------------- Playermarker --------------------------------------------------------------------------
	...
	// im folgenden Beispiel werden 5 Gruppenfhrer und ein Pilot mit einem Marker ausgestattet, im folgenden die Syntax:
...
//-------------------------------------------------------------------------- Sichtweiten --------------------------------------------------------------------------
	...
	// hier knnen die einstellbaren Sichtweiten fr den Spieler definiert werden
