...
if (isClass(configFile >> "CfgPatches" >> "addons\opt3_magRepack")) exitWith {};
...
[] execVM "addons\opt3_magRepack\Scripts\MagRepack_Main.sqf";
[] execVM "addons\opt3_magRepack\Scripts\MagRepack_Keybindings.sqf";
[] execVM "addons\opt3_magRepack\Scripts\MagRepack_Misc.sqf";
