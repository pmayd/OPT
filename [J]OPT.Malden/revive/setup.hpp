...
#define FAR_REVIVE_ACTION_FIRST_AID "Eigenversorgung"

#define FAR_REVIVE_ACTION_REVIVE_BAR_TEXT "Wiederbelebungsmaßnahmen werden %1 s in Anspruch nehmen..."
#define FAR_REVIVE_ACTION_FIRST_AID_BAR_TEXT "Eigenversorgung wird %1 s in Anspruch nehmen..."
...
#define FAR_REVIVE_ACTION_NOT_STABILIZED "Patient muss zunächst stabilisiert werden."
...
#define FAR_REVIVE_RESPAWN_BUTTON(cost) format["Respawn (%1 €)", cost]
