...
#define REPAIR_SYSTEM_ACTION_REFUEL_DONE FORMAT_1("Fahrzeug fertig betankt für %1 €",GVARMAIN(repairSystem_refuelCost))
...
#define REPAIR_SYSTEM_ACTION_REPAIR_DONE FORMAT_1("Fahrzeug vollständig repariert für %1 €",GVARMAIN(repairSystem_repairCost))
