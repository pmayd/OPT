...
GVAR(Pawnee)=[[0,1,2,4,8,9,10,11,13],[0,1,2,5],[0,0],[1],[2,2]];
...
GVAR(Panther)=[[],[0,1,2,7,8,9,10,11],[0,1],[1],[0,4]];
GVAR(Marshall)=[[],[0,1,2,3,4,5,6,12,13],[1,1],[1],[0,4]];
GVAR(Mora)=[[],[0,1,2,3,4,5,6,14,15,16,18,19],[1,1],[1],[0,4]];
GVAR(Cheetah)=[[],[20,21,22,23],[0,1],[1],[0,4]];
GVAR(SlammerUp)=[[],[0,1,2,3,4,5,6,24,25,26,27,28,29,30,30,32,38],[0,1],[1],[0,4]];

//EAST Einheiten
GVAR(Orca)=[[0,1,2,4,8,9,10,11,13],[0,1,2,8],[0,0],[1],[2,2]];
GVAR(hellcat)=[[0,1,2,4,8,9,10,11,13],[0,1,2,8],[0,0],[1],[2,2]];
...
GVAR(Marid)=[[],[0,1,2,3,7,8,9,10,11],[0,1],[1],[0,4]];
GVAR(Gorgon)=[[],[0,1,2,3,4,5,6,12,13],[1,1],[1],[0,4]];
GVAR(Kamysh)=[[],[0,1,2,3,4,5,6,14,15,16,18,19],[1,1],[1],[0,4]];
